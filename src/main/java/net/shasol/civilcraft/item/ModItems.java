...
public class ModItems {
    ...
    //Simple Mod Items
    public static final DeferredItem<Item> COPPER_WIRE_COIL = ITEMS.registerSimpleItem("copper_wire_coil");
    ...
    public static final DeferredItem<Item> COPPER_FINE_WIRE_COIL = ITEMS.registerSimpleItem("copper_fine_wire_coil");
